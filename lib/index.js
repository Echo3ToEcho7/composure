...
var Composure = function Composure() {
  if (!(this instanceof Composure)) {
...
Composure.prototype.set = function set(key, value) {
  this["_" + key] = value;

  return this;
};

Composure.prototype.get = function get(key, dValue) {
  return this["_" + key] || dValue;
};

Composure.prototype.service = function service(name) {
...
Composure.prototype.name = function name(n) {
  return this.set("name", n);
};

Composure.prototype.version = function version(ver) {
  if (!semver.valid(ver)) {
...
Composure.prototype.listen = function listen(port, cb) {
  var i, ii, j, jj;
  var service, path;
  var verb;
  var info = {};
